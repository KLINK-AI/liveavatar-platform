...
class Settings(BaseSettings):
    ...
    elevenlabs_model_id: str = "eleven_multilingual_v2"  # Fallback: high-quality multilingual
    elevenlabs_turbo_model_id: str = "eleven_turbo_v2_5"  # Default for all TTS: 60-70% faster
